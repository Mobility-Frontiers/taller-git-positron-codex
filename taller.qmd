...
Lo primero, antes de clonar nada: Positron necesita saber con qué cuenta de GitHub va a trabajar. El ícono de cuenta está en la esquina inferior izquierda de la barra de actividad. Si todavía no hay sesión iniciada, ese menú muestra la opción **Sign in with GitHub to use Git and GitHub features**; una vez conectado, el mismo lugar pasa a mostrar el nombre de usuario:
