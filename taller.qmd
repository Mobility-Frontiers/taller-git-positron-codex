...
La convención anterior depende de que cada persona la respete por su cuenta. GitHub permite además reforzarla técnicamente a nivel de repositorio, para que sea imposible saltársela por error. Esta configuración se hace una sola vez por repositorio, idealmente por quien lo administra:
...
4. Marcar como mínimo **Require a pull request before merging** — con esto, GitHub rechaza cualquier intento de `push` directo a `main` y exige que el cambio llegue por PR.
...
::: {.exercise}
**Ejercicio 5 — Usar Codex con el modelo adecuado para cada tarea**
